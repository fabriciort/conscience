...
export default function SignupPage() {
  const [formData, setFormData] = useState({
    ...
    password: '',
    confirmPassword: '',
    userType: 'professional' as 'researcher' | 'professional' | 'student' | 'company',
  });
        ...
        <div className="w-full max-w-md">
          <Card padding="lg">
            <CardHeader className="text-center">
              <CardTitle className="text-3xl mb-2">Criar Conta</CardTitle>
              <CardDescription>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  <label className="flex items-start gap-2 cursor-pointer">
                    ...
                    <span>
                      Concordo com os{' '}
                      <Link href="/termos" className="text-coral hover:underline">
                        Termos de Uso
                      </Link>
                      {' '}e{' '}
                      <Link href="/privacidade" className="text-coral hover:underline">
